...
import numpy as np
import threading
from network.prioritize import Experience
...
class ReplayBuffer:
    ...
    def __init__(self, args):
        ...
        self.proportional = Experience(self.size, alpha=self.args.alpha)
        ...
        self.buffers = {
            ...
            'noise': np.empty([self.size, args.noise_dim]),
    ...
    def can_sample(self, batch_size):
        return self.current_size >= max(batch_size, self.args.burn_in_period)
    ...
    def store_episode(self, episode_batch):
        ...
        with self.lock:
            ...
            self.buffers['noise'][idxs] = episode_batch['noise']
